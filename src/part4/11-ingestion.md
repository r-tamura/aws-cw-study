...
**AWS 公式ドキュメント**
- [CloudWatch pipelines](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/cloudwatch-pipelines.html) — Pipelines のソース・プロセッサ・シンク構成と利用可能リージョン
- [Parser processors (OCSF / CSV / Grok ほか)](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/parser-processors.html) — OCSF など各 parser の挙動と Conditional Processing の制約
- [Use facets to group and explore logs](https://docs.aws.amazon.com/AmazonCloudWatch/latest/logs/CloudWatchLogs-Facets.html) — Facets による低カーディナリティフィールドのインタラクティブ探索
- [Access logs with S3 Tables Integration](https://docs.aws.amazon.com/AmazonCloudWatch/latest/logs/s3-tables-integration.html) — Log group を Apache Iceberg テーブルとして S3 へ公開し Athena/Redshift から SQL で扱う

**AWS ブログ / アナウンス**
- [Amazon CloudWatch introduces unified data management and analytics for operations, security, and compliance](https://aws.amazon.com/blogs/aws/amazon-cloudwatch-introduces-unified-data-management-and-analytics-for-operations-security-and-compliance/) — 取り込みメニュー誕生の背景となる re:Invent 2025 統合発表（2025/12）
- [Amazon CloudWatch unified data and telemetry](https://aws.amazon.com/cloudwatch/features/unified-data-and-telemetry/) — Pipelines / Facets / S3 Tables を「統合データ＆テレメトリ」として束ねた製品ページ
